...
RUN python ghost_hunter.py \
 ...
 && python -c "import paths,ssq_log,pattern_audit,engine_core,data,store,run_cycle,daemon_loop,frontier,make_dashboard,nonstationarity,evaluator,cache,diff_formula,positive_control,redteam_audit,representation_zoo,layered_null,run_axes,firewall,proposer,scoring,formula_viz,predict_tonight,ssq_health,learning_contract,failure_absorber,ingest_candidates,axis_proposer,review_primitives,bias_corrector,formula_composer,formula_research,watchdog_mode,seed_bridge,verify_df_gen,progress_gate,blue_evolve,changepoint_evolve,gru_evolve,seq_evolve,novelty_search,reflective_designer; print('IMPORT_OK')"
